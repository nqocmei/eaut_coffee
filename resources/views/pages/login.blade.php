        ...
        <div class="main mt-3 mt-md-5 pt-md-5 mx-auto">
            <form action="{{ route('login') }}" method="POST" class="form mt-5 pt-2">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" class="form-control" placeholder="Nhập email của bạn">
                ...
                <div class="mt-2 fs-6">
                    Quên mật khẩu? <a class="account-register" href="{{ route('password.request') }}">Lấy lại mật
                        khẩu</a>
                </div>
            </form>
        </div>
